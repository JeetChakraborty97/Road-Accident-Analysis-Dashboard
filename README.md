...
# Executive Summary – Road Accident Analysis Dashboard (2021–2022) 
...
• Total Casualties: 417,858 people were recorded as casualties in the analyzed period. 

• Accident Severity Breakdown: 

o Fatal: 7,135 (≈1.7%) 

o Serious: 59,306 (≈14.2%) 

o Slight: 351,417 (≈84.1%) 

• Maximum Casualties by Vehicle Type: 

o Cars accounted for the highest proportion (≈333,463 or ~80%), followed by two wheelers (33,672), vans (33,469), buses (12,798), and agricultural vehicles (1,032). 

o This highlights cars as the primary contributor to accident casualties. 

2. Secondary KPIs 

• Casualties by Vehicle Type Distribution: 
...
• Ministry of Transport & Road Safety Corps: Insights for national road safety strategies and investment in infrastructure. 

• Police & Emergency Services: Enables resource allocation for accident-prone areas and times. 

• Traffic Management Agencies & Transport Operators: Identifies critical vehicle categories (cars, bikes) for policy and awareness campaigns. 

• Public & Media: Transparency in accident trends and targeted awareness campaigns. 
...
• Two-Wheelers (Bikes, 33,672 casualties): 
...
• Commercial Transport (Vans & Buses): 
...
• High-Risk Road Types (A-roads & Motorways): 
...
• Create a National Accident Database updated in real-time by police, hospitals, and transport departments. 

• Expand the dashboard to include predictive analytics (forecasting hotspots based on historical patterns). 

• Publish quarterly accident reports for transparency and accountability. 
...
• Process: The raw accident dataset was cleaned and structured into a usable format. 

• Methods: 

o Removal of duplicates, missing, and inconsistent records. 

o Standardization of categorical fields (e.g., “Fatal”, “Serious”, “Slight” severity codes). 
...
2. KPI Development (Sheet: KPI’s) 

• Process: Computation of key performance indicators (KPIs) aligned with the problem statement. 
...
▪ Casualties by severity (Fatal, Serious, Slight) with % contribution. 

▪ Casualties by vehicle type. 

o Secondary KPIs: 

▪ Cross-tabulations between accident severity and vehicle types. 

▪ Proportion analysis using pivot tables (e.g., % of car-related casualties). 
...
• Process: Understanding how casualties vary across months and years. 
...
• Sheets: Pvt. Casualties by Road Type and Pvt. Casualties by Road Surface 

• Process: Exploring the relationship between casualties and external conditions. 
...
5. Correlation Analysis (Sheet: Other Pvt’s and Donut Charts) 

• Process: Examining combined factors such as casualties by Area (Urban vs Rural) and Time (Day vs Night). 
...
• Process: Collecting intermediate outputs into a structured analytical layer. 
...
• Process: Creating an interactive visualization interface. 
...
▪ Column chart → Vehicle type breakdown. 

▪ Donut/pie charts → Road surface & day/night distribution. 
...
1. Data Cleaning & Structuring → Built a reliable base dataset. 

2. KPI Calculation → Aligned with client’s problem statement. 

3. Exploratory Pivot Analysis → Trends, distributions, correlations. 

4. Visualization Layer → Dashboard charts, slicers, interactivity. 

5. Storytelling for Decision-Making → Translating insights into actionable findings.
